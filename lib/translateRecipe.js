...
// the missing-try/catch bug this was found alongside). Bumped from 45s to 75s when the Edge
// Function moved from Haiku 4.5 to Sonnet 5 -- Sonnet is meaningfully slower per token than
// Haiku, so the old Haiku-tuned budget left less safety margin than intended even for a large
// multi-process recipe; this is a backstop for a genuinely stuck request, not a tight budget
// expected to matter on a normal call.
const TRANSLATE_TIMEOUT_MS = 75_000;
