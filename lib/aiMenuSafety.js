...
//   Turkey, lamb, egg, dairy and vegetarian snacks stay allowed (confirmed 2026-09-24).
...
const CATEGORY_RULES = [
  ...
  },
  {
    ...
    check: ({ name, description, ingredients, dish }) => {
      const hits = [];
      const why = 'chicken and beef are served at lunch only — never in AM or PM Snack (turkey, egg, dairy and vegetarian snacks are fine)';
