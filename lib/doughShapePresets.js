...
async function savePreset(input) {
  ...
  // the new values instead of failing on the unique-name conflict -- names are unique, so re-adding a
  // deleted shape's exact name has nowhere else to go but this same row.
