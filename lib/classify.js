...
function suggestClassification(name, mealPeriod) {
  ...
  if (VEGETABLE_KEYWORDS.some(k => n.includes(k))) return { category: 'LUNCH_VEGETABLE', protein: null, isDailyRepeating: false };
