...
// Turkey first (2026-09-24): "Turkey Ham ..." is turkey, never chicken.
const PROTEIN_KEYWORDS = [['turkey', 'TURKEY'], ['chicken', 'CHICKEN'], ['beef', 'BEEF'], ['lamb', 'LAMB'], ['lamp', 'LAMB'], ['fish', 'FISH']];
...
module.exports = { suggestClassification, detectProtein };
