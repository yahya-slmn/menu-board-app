...
const STAFF_ROW_MAP = {
  ...
  // STAFF_FRUIT_BASKET and STAFF_JUICE are no longer scheduled (removed 2026-09-24 / replaced by
  // the fixed beverages 2026-09-23); kept so menus saved before then still export.
