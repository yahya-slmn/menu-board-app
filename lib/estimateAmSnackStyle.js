...
const CLASSIFY_TIMEOUT_MS = 75_000;
...
// category: 'AM_SNACK' (default) / 'PM_SNACK' / 'STAFF_BREAKFAST' -- what Pastry and Cold Kitchen mean
// differs per category (see the Edge Function's CATEGORY_DEFINITIONS).
async function estimateAmSnackStyle({ items, category = 'AM_SNACK' }) {
