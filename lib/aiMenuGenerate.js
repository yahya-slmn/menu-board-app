...
function poolSpecs() {
  ...
  return [
    ...
    perSection('STAFF', 'STAFF_BREAKFAST', 4, {
      ruleAttrs: ['dish_concept', 'am_snack_style'], spreadAttr: 'dish_concept', compositionTopupFactor: 2,
      ...
      // plus a meat-free dish of each style: any 2 + 2 free types can then be filled, one meat-free.
      tuesdayGroups: () => ['PASTRY', 'COLD_KITCHEN'].flatMap((style) => [
        ...
        { count: 1, fixed: { protein_code: 'VEGETARIAN', am_snack_style: style }, spread: { attr: 'dish_concept' } },
      ]),
    }),
