...
// together represent a single recipe card (see the Edge Function's PROMPT), sent as one call so
// the model has full cross-page context instead of extracting each file in isolation.
